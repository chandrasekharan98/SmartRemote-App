...
public class BannerMovieAdapter extends RecyclerView.Adapter<BannerMovieAdapter.MyViewHolder>{
    ...
    public BannerMovieAdapter(Context mContext, List<Zmovies> moviesList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.activity_banner_movie, parent, false);
